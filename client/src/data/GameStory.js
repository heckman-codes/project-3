...
export default [
  ...
  },
  {
    ...
    title: "Introduction",
    text:
      "You never were good at goodbyes, and Pete’s scavenging skills are as faded as his memory these days. You rev up the engine and begin your journey across US 50.",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_1.gif",
    progress: 0,
    options: [
  ...
  },
  {
    ...
    title: "Bee",
    text:
      "With one hand on the wheel, you try and swat the bee away. It instinctively stings you. Ouch.",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_4.jpg",
    progress: 12,
    // action: 3
  ...
  },
  {
    ...
    title: "Check Engine",
    text:
      "You take a look under the hood. Looks like the issue is thankfully just a loose fuel cap. You solve the issue and keep driving.",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_13.jpg",
    progress: 48,
    options: [
  ...
  },
  {
    ...
    title: "Twilight Park",
    text:
      "Shopkeep: “Many travellers have ended their journey here, deciding to live out there days in Twilight Park. We sell what they no longer need.”",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_14.webp",
    progress: 52,
    options: [
  ...
  },
  {
    ...
    title: "Fissure",
    text:
      "You slam on the fuel, jumping the fissure. You make it across, but the car slams hard into the pavement, damaging the body. But you are able to keep driving.",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_15.jpg",
    progress: 56,
    // action: -5 gas
  ...
  },
  {
    ...
    title: "Red Rain",
    text:
      "You slam on the fuel, trying to outrun the storm. You manage to stay ahead of the squall, but red rops still burn through the roof of your car, tainting some supplies.",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_21.jpg",
    progress: 82,
    options: [
  ...
  },
  {
    ...
    title: "Winter is Coming",
    text:
      "You try catching some flakes on your tongue, but the white specs feel warm on touch. What you thought was snow turns out to be ash. You cough and sputter, making your way back to the car.",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_24.gif",
    progress: 94,
    options: [
  ...
  },
  {
    ...
    title: "The Home Stretch",
    text:
      "You leave some supplies, but that’s not important. You run, body exhausted from driving, the car starts burning behind you. You can see the entrance gates…",
    image:
      "https://project-3-arcade-game.s3-us-west-2.amazonaws.com/frame_25.jpg",
    progress: 98,
    options: [
  ...
  },
  {
    ...
    title: "Safe at Last",
    text:
      "The concrete gates open, and everything becomes a blur. Armed guards take you to a quarantine tent. You get examined, tested, and questioned. It’s all overwhelming. But you get fed a warm meal. And you sleep under a warm blanket. After a few days, you step out of the quarantine tent and into the city, a society of survivors. You can now rest comfortably, you have survived, the long way.",
    image:
